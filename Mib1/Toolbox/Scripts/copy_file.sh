...
# for instance ./copy_file.sh "This script will copy a new FEC container onto your device" "FEC" "/Custom/Advanced/FEC/FecContainer.fec" "/net/rcc/mnt/efs-persist/FEC/FecContainer.fec"
...
BACKUPFOLDER=$VOLUME/Backup/$VERSION/$TOPIC/
